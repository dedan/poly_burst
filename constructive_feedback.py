"""ConstructiveFeedback.py 

        This file contains a feedback to construct images directly from the polygons. The experiment runs as follows: 
                1) An image is presented to the subject for a while. 
                2) Stimuli consisting of single polygons are presented to the subject. They are generated by random. 
                3) If the subject identifies a stimulus as belonging to the image presened before, this polygon is selected and becomes part of a constant stimulus. Further candidates are presented together with the constant stimulus. 
                
        The aim of this feedback is to implement the original scheme of image reconstruction. Modifications shall be done to adapt the original ideas to the reality and complexity of the problem. 
        
    This file includes: 
        classes: 
            >> ConstructiveFeedback: the feedback described above. Abreviated TF. 
        functions: 
